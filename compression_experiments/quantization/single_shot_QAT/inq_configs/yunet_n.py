optimizer = dict(type='SGD', lr=1e-4, momentum=0.9, weight_decay=0)
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='logynthetic/yunet_labels/train_annotations.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='logynthetic/yunet_labels/calibration_annotations.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file='logynthetic/yunet_labels/test_annotations.txt',
