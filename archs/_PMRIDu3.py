...
class PMRIDu3(nn.Module):
    ...
    def __init__(self):
        ...
        self.enc2 = EncoderStage(in_channels=16, out_channels=64, num_blocks=2)
        self.enc3 = EncoderStage(in_channels=64, out_channels=128, num_blocks=2)
        self.enc4 = EncoderStage(in_channels=128, out_channels=256, num_blocks=2)
