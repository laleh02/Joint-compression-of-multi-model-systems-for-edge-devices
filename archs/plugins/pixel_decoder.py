...
class PixelDecoderYuNet(BaseModule):
...
@PLUGIN_LAYERS.register_module()
class TransformerEncoderPixelDecoderYuNet(PixelDecoderYuNet):
    ...
    def forward(self, feats, img_metas):
        ...
        input_img_h, input_img_w = img_metas[0]['batch_input_shape'][1:] #adapted for torch jit
