...
class PMRIDd2(nn.Module):
    ...
    def __init__(self):
        ...
        self.enc2 = EncoderStage(in_channels=8, out_channels=32, num_blocks=2)
        self.enc3 = EncoderStage(in_channels=32, out_channels=64, num_blocks=4)
        self.enc4 = EncoderStage(in_channels=64, out_channels=64, num_blocks=4)

        self.encdec = Conv2D(in_channels=64, out_channels=32, kernel_size=3, padding=1, stride=1, is_seperable=True, has_relu=True)
        ...
        self.dec3 = DecoderStage(in_channels=16, skip_in_channels=8, out_channels=8)
